...
public class SPSReconfigcirc3_std_4guasti_0 implements Scenario {
	...
	private void init_experiment() {
		...
		circuito.add_load(33, 15, 5, LoadDescriptor.NONVITAL, 7);
		circuito.add_load(36, 18, 5, LoadDescriptor.NONVITAL, 8);
		circuito.add_load(42, 21, 5, LoadDescriptor.NONVITAL, 9);
		circuito.add_load(45, 24, 5, LoadDescriptor.NONVITAL, 10);
