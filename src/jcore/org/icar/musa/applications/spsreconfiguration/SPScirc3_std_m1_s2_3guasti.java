...
public class SPScirc3_std_m1_s2_3guasti implements Scenario {
	private SPSCircuit circuito;
	private int sub_scenario = 1;
	private int mission = 1;
	
	public SPScirc3_std_m1_s2_3guasti() {
		super();
		init_experiment();
	}
...
//		circuito.add_failure(2,3);
//		circuito.add_failure(3, 4);
//		circuito.add_failure(4, 5);
//		circuito.add_failure(18, 19);
	}

	@Override
	public String getName() {
		return "circ3-std-m1-s1-3guasti";
	}
