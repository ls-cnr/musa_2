...
/**
 * The Class WorldNode. It's the standard node of the graph of the solutions. It
...
public class WorldNode implements Node {
	...
	/**
	 * The hash code. It's calculated only one time inside the constructor and
	 * stored inside the object to speed up the operations inside the HashMap
	 */
	...
	/**
	 * This method calculate the hashcode of the object. the value is stored inside
	 * the object.
	 *
	 * @return the hashcode, based on the StateOfWorld hashCode(). return 0 if
	 *         worldstate is null.
	 */
