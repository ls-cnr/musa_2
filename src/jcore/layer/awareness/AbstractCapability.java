...
/**
 * The Class AbstractCapability encapsulate a capability. A capability is an
 * atomic and self-contained action the system may intentionally use to address
 * a given evolution of the state of the world. Each abstract capability can be
 * implemented by several concrete capabilities.
 *
 * @author icar-aose
 */
...
public class AbstractCapability implements RunTimeEntity {
	...
	/**
	 * The evolution set are the differences between a state of the world and his
	 * next, generated after executing the capability .
	 */
	...
	/**
	 * The post is a condition that the capability must satisfy to prove it has been
