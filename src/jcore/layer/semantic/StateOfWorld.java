...
/**
 * This class encapsulate a possible State Of World, i.e. a set of facts
 * describing what the system knows about the environment. for goal-testing
 * reasons, each fact is given in ASP, i.e. a subclass of MyDLPHead
 *
 * @author icar-aose
 */
...
public class StateOfWorld {
	...
	/**
	 * Facts: Set of Facts. A fact is considered as a first order variable-free
	 * statement to which is possible to assign a truth value.
	 */
	 ...
	 *             the parse exception
	 * @throws NotAllowedInAStateOfWorld
	 *             the not allowed in A state of world
	 */
	...
	public String toString() {
		...
		for (ExtDLPHead temp : this.facts)
			res = String.join(res, temp.toString(), "\n");
