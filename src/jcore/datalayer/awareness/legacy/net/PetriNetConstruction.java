...
public class PetriNetConstruction {
	 ...
	 * @return last Place created
	 */
	private Place netConstruction( Place place, Place last, GS_Goal g_root ) {
	 ...
	 * @return last Place created
	 */
	private Place basicTemplate( Place place, Place last, GS_Goal goal ) {
	 ...
	 * @return last Place created
	 */
	private Place parallelTemplate( Place place, Place last, GS_Goal goal, ArrayList<RefinementArc> arcs ) {
		//First Transition, it represents represents Goal's trigger condition
		Transition t1 = pn.transition("t"+t++);
		addTriggerCondition(t1, goal);
		//Second Transition, it represents Goal's final state
	 ...
	 * @return last Place created
	 */
	private Place conditionalTemplate( Place place, Place last, GS_Goal goal, ArrayList<RefinementArc> arcs ) {
		//First Transition, it represents represents Goal's trigger condition
		Transition t1 = pn.transition("t"+t++);
		addTriggerCondition(t1, goal);
		//Second Transition, it represents Goal's final state
	 ...
	 *            the goal
	 */
	private void addTriggerCondition( Transition transition, GS_Goal goal) {
	 ...
	 *            the goal
	 */
	private void addFinalState( Transition transition, GS_Goal goal) {
