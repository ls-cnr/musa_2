...
public class PENetTest {
	...
	public void init() {
		...
		CU = new AbstractCapability("check_user", CU_evo, CU_pre, null);
		...
		AU = new AbstractCapability("add_user", AU_evo, AU_pre, null);
		...
		SRF = new AbstractCapability("send_registration_form", SRF_evo, SRF_pre, null);
		...
		WUD = new AbstractCapability("wait_user_data", WUD_evo, WUD_pre, null);
		...
		CS = new AbstractCapability("check_storehouse", CS_evo, CS_pre, null);
		...
		NSF = new AbstractCapability("notify_stock_failure", NSF_evo, NSF_pre, null);
		...
		GI = new AbstractCapability("generate_invoice", GI_evo, GI_pre, null);
		...
		UOUCS = new AbstractCapability("upload_on_user_cloud_storage", UOUCS_evo, UOUCS_pre, null);
		...
		UOPCS = new AbstractCapability("upload_on_private_cloud_storage", UOPCS_evo, UOPCS_pre, null);
		...
		SFL = new AbstractCapability("share_file_link", SFL_evo, SFL_pre, null);
		...
		NSM = new AbstractCapability("notify_storehouse_manager", NSM_evo, NSM_pre, null);
