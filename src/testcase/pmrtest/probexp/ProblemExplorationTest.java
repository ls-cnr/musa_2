...
public void setUp(){
	...
	this.wStart.addFact_asASP(new ExtDLPHead(new DLPAtom("available", an_order)));
	this.wStart.addFact_asASP(new ExtDLPHead(new DLPAtom("user", a_user)));
	this.wStart.addFact_asASP(new ExtDLPHead(new DLPAtom("user_data", the_user_data)));
	*/
